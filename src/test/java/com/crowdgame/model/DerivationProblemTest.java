...
public class DerivationProblemTest {

	private DerivationProblem problem = new DerivationProblem();
	...
	private static final List<String> expectedDisplayText = 
			Lists.newArrayList("p", "a", "l");
	private static final List<String> expectedDisplayAnswers = 
			Lists.newArrayList("abra", problemAnswer1, problemAnswer2);
